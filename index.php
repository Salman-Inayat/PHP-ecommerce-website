                                                    ...
                                                    <div class="products">
                                                        <div class="product">
                                                            <div class="product-image">
                                                                <div class="image">
                                                                    <a href="product-details.php?pid=<?php echo ($row['id']); ?>">
                                                                        <img src="<?php echo ($row['productImage1']); ?>" width="220" height="300" alt=""></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <?php if ($row['productAvailability'] == 'In Stock') { ?>
                                                                <div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="icon-button btn btn-primary"><span><i class="glyphicon glyphicon-shopping-cart"></i></span></a>
                                                                    <a class="icon-button btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo ($row['id']) ?>&&action=wishlist">
                                                ...
                                                <div class="item item-carousel">
                                                    <div class="products">
                                                        <div class="product">
                                                            ...
                                                            <?php if ($row['productAvailability'] == 'In Stock') { ?>
                                                                <div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="icon-button  btn btn-primary">Add to Cart</a></div>
                                                            <?php } else { ?>
                                                ...
                                                <div class="item item-carousel">
                                                    <div class="products">
                                                        ...
                                                        <div class="product">
                                                            <div class="product-image">
                                                                <div class="image">
                                                                    <a href="product-details.php?pid=<?php echo ($row['id']); ?>"><img src="<?php echo ($row['productImage1']); ?>" width="220" height="300"></a>
                                                                </div>
                                                            </div>
                                                            <div class="product-info text-left">
                                                                <h3 class="name"><a href="product-details.php?pid=<?php echo ($row['id']); ?>"><?php echo ($row['productName']); ?></a>
                                                            ...
                                                            <?php if ($row['productAvailability'] == 'In Stock') { ?>
                                                                <div class="action">
                                                                    <a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="icon-button  btn btn-primary">
