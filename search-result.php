                                                    ...
                                                    <div class="products">
                                                        <div class="product">
                                                            <div class="product-image">
                                                                <div class="image">
                                                                    <a href="product-details.php?pid=<?php echo ($row['id']); ?>"><img src="<?php echo ($row['productImage1']); ?>" alt="" width="200" height="300"></a>
                                                                </div>
                                                            </div>
                                                            <div class="product-info text-left">
                                                                ...
                                                                <div class="product-price">
                                                                    ...
                                                                    <span class="price-before-discount">Rs.<?php echo ($row['productPriceBeforeDiscount']); ?></span>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li class="lnk wishlist">
                                                                            <a class="add-to-cart" href="category.php?pid=<?php echo ($row['id']) ?>&&action=wishlist" title="Wishlist">
