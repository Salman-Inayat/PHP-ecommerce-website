                                    ...
                                    <tbody>
                                        ...
                                        if ($num > 0) {
                                            while ($row = mysqli_fetch_array($ret)) { ?>
                                                <tr>
                                                    <td class="col-md-2">
                                                        <img src="<?php echo ($row['pimage']); ?>" alt="<?php echo ($row['pname']); ?>" width="60" height="100">
                                                    </td>
                                                    <td class="col-md-6">
                                                        <div class="product-name"><a href="product-details.php?pid=<?php echo ($pd = $row['pid']); ?>"><?php echo ($row['pname']); ?></a>
                                                        </div>
                                                    ...
                                                    <td class="col-md-2 close-btn">
                                                        <a href="my-wishlist.php?del=<?php echo ($row['wid']); ?>" onClick="return" class=""><i class="fa fa-times"></i></a>
                                                    </td>
                                                </tr>
                                            <?php }
                                        } else { ?>
